...
DOCGEN_PARSERS=(
  ...
  "docgen -- parsers shellCommandParser"
  "docgen -- parsers shellArgumentParser"
        ...
        "parsers")
            ...
            case "$__docgen__mainCliCommands_command3" in
              ...
              ## @
                  ...
                  ;;
              ## @command docgen -- parsers shellArgumentParser
              "shellArgumentParser")
                local __docgen_parsers_shellArgumentParser_documentationText
                if docgen x lines current getDocumentation __docgen_parsers_shellArgumentParser_documentationText
                then
                  if [[ "$__docgen_parsers_shellArgumentParser_documentationText" = '$'* ]]
                  then
              ...
              ## @
                  ...
                  ;;
              ## @command docgen -- parsers shellCommandParser
              "shellCommandParser")
                
                local __docgen_parsers_shellCommandParser_documentationText
                if docgen x lines current getDocumentation __docgen_parsers_shellCommandParser_documentationText
                then
                  ...
                  then
                    ...
                    docgen x context write ".docgen/fullName" "$__docgen_parsers_shellCommandParser_fullCommandName"
                    return 0
                  fi
                fi
    ...
    "context")
      ...
      case "$__docgen__mainCliCommands_command2" in
        ...
        ## @
            ...
            ;;
        ## @command docgen context getChildPaths
        "getChildPaths")
          # Determine context identifier
          local __docgen_context_getChildPaths_contextName=':default'
          [[ "$1" = ":"* ]] && { __docgen_context_getChildPaths_contextName="$1"; shift; }
          
          # Get context current directory (this has the side-effect of asserting the validity of the context identifier)
          local __docgen_context_getChildPaths_contextCurrentDirectory=''
          docgen context getDirectory "$__docgen_context_getChildPaths_contextName" __docgen_context_getChildPaths_contextCurrentDirectory || return $?
          
          # Get the root directory
          local __docgen_context_getChildPaths_rootDirectory=''
          docgen context getRootDirectory "$__docgen_context_getChildPaths_contextName" __docgen_context_getChildPaths_rootDirectory
          
          local __docgen_context_getChildPaths_childNodeName=''
          while read -rd '' __docgen_context_getChildPaths_childNodeName
          do
            [ "$__docgen_context_getChildPaths_childNodeName" = "$__docgen_context_getChildPaths_contextCurrentDirectory" ] && continue
            local __docgen_context_getChildPaths_childNodePath="${__docgen_context_getChildPaths_childNodeName#$__docgen_context_getChildPaths_rootDirectory}"
            __docgen_context_getChildPaths_childNodePath="${__docgen_context_getChildPaths_childNodePath#/}"
            if [ -n "$1" ]
            then
              eval "$1+=(\"\$__docgen_context_getChildPaths_childNodePath\")"
            else
              echo "$__docgen_context_getChildPaths_childNodePath"
            fi
          done < <( find "$__docgen_context_getChildPaths_contextCurrentDirectory" -maxdepth 1 -type d -not -name .docgen -print0 )
        ## @
        ...
        "goto")
            ...
            case "$__docgen__mainCliCommands_command3" in
              ...
              "parent")
                ...
                # TODO make this work properly with tests etc, really quick hack...
                
                if [ -d "${__docgen_context_gotoParent_contextCurrentDirectory%/*}" ]
                then
                  # Find this context (asserting that it exists) - O(N) operation <-- which is done very frequently too. Please don't make many contexts!
                  local __docgen_context_gotoParent_contextSearchIndex=0
                  while [ "$__docgen_context_gotoParent_contextSearchIndex" -lt "${#_DOCGEN_CONTEXT_NAMES[@]}" ]
                  do
                    if [ "${_DOCGEN_CONTEXT_NAMES[$__docgen_context_gotoParent_contextSearchIndex]}" = "$__docgen_context_gotoParent_contextName" ]
                    then
                      _DOCGEN_CONTEXT_CURRENT_DIRECTORIES[$__docgen_context_gotoParent_contextSearchIndex]="${__docgen_context_gotoParent_contextCurrentDirectory%/*}"
                      # _DOCGEN_CONTEXT_CURRENT_DIRECTORIES[$__docgen_context_gotoParent_contextSearchIndex]="$__docgen_context_gotoParent_contextCurrentDirectory/$1"
                      return 0
                    fi
                    : "$(( __docgen_context_gotoParent_contextSearchIndex++ ))"
                  done
                else
                  docgen x errors contextError '%s\n%s\n%s' "Parent not found: $__docgen_context_gotoParent_contextCurrentDirectory/$1" "Location: $__docgen_context_gotoParent_contextCurrentDirectory" "Command: docgen ${__docgen__originalCliCommands[*]}"
                  return 1
                fi
              ## @
              ...
              "commands")
                    ...
                    case "$__docgen__mainCliCommands_command4" in
                      ...
                      "list")
                        ...
                        then
                          docgen context getChildPaths "$__docgen_x_contextProviders_commands_list_contextName" "$@"
                          return $?
