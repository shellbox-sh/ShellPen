...
PROJECT_NAME="ShellPen"
FILE_WITH_VERSION_VARIABLE="shellpen.sh"
VERSION_VARIABLE="SHELLPEN_VERSION"
API_LATEST_RELEASE_INFO_URL="https://api.github.com/repos/$REPO_ORG/$PROJECT_NAME/releases/latest"
FILES_TO_COPY=("shellpen.sh")
INSTALL_MESSAGE="Installed 🖋️ ShellPen.sh

- shellpen.sh - Source shx as a library

Getting Started:

 - source shellpen.sh
 - shellpen            # Prints usage documentation

Visit https://shellpen.sh for documentation
"
########################
